...
class Game:
    ...
    def start_game_gui_mode(self):
        ...
        # create game ui which takes the game as input
        # when button is clicked, you can handle everything in the ui itself by calling the appropriate game functions over there
